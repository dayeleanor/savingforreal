import styles from "./blog-page-header-info.module.scss";
import { IBlogPostData } from "../../contentful/queries";

interface IBlogPageHeaderInfoProps {
  post: IBlogPostData;
}

const BlogPageHeaderInfo: React.FC<IBlogPageHeaderInfoProps> = ({ post }) => (
  <ul className={styles.headerInfo}>
    <li>
      ...
      <div>
        ...
        <span id="lastUpdated">{post.lastUpdated}</span>
      </div>
    </li>
    <li>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <span id="publishedAt">{post.publishedAt}</span>
      </div>
    </li>
  </ul>
);

export default BlogPageHeaderInfo;
